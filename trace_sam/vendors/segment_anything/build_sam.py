...
def build_sam_vit_h(image_size=1024, keep_resolution=False, checkpoint=None, num_multimask_outputs=3):
    return _build_sam(
...
def build_sam_vit_l(image_size=1024, keep_resolution=False, checkpoint=None, num_multimask_outputs=3):
    return _build_sam(
...
def build_sam_vit_b(image_size=1024, keep_resolution=False, checkpoint=None, num_multimask_outputs=3):
    return _build_sam(
